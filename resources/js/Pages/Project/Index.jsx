        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-#f1f1f1 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <table className='w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400'>
                                ...
                                <tbody>
                                    {projects.data.map(project => (
                                        <tr className='bg-#f1f1f1 border-b dark:bg-gray-800 dark:border-gray-700' key={project.id}>
                                            <td className='px-3 py-2'>{project.id}</td>
                                            <td className='px-3 py-2'>
                                                <img src={project.image_path} style={{width:60}} alt="project image" />
                                            </td>
                                            ...
                                            <td className='px-3 py-2'>
                                                ...
                                                <Link href={route('project.destroy', project.id)} className='font-medium text-red-600 dark:text-red-500 hover:underline mx-2'>
                                                    Delete
                                                </Link>
                                            </td>
                                        </tr>
